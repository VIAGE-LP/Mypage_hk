...
const SETTING_COD_MEMO          = `Viage晚安立體美型內衣，能夠幫助您打造完美胸型，解決您對各種內在美的煩惱。您貴重的商品，我們將以「順豐速運」進行最專業的配送服務，寄件者將顯示為「台灣娜珂黛肌」。<br>
★ 提醒您，因新型冠狀病毒影響，由2022年3月5日起，順豐香港暫停上門收派服務，直至另行通知。若希望改以順豐營業點、順豐站、順豐合作點及順便智能櫃使用自寄自取服務請聯繫客服告知。<br>
* 現時疫情對收派快件操作造成不同程度的影響，所有快件的時效將不作保證<br>
* 最新資訊以順豐速運公告為基準`;
const SETTING_CONV_MEMO         = `Viage晚安立體美型內衣，能夠幫助您打造完美胸型，解決您對各種內在美的煩惱。您貴重的商品，我們將以「順豐速運」進行最專業的配送服務，寄件者將顯示為「台灣娜珂黛肌」。<br>
★ 提醒您，因新型冠狀病毒影響，由2022年3月5日起，順豐香港暫停上門收派服務，直至另行通知。若希望改以順豐營業點、順豐站、順豐合作點及順便智能櫃使用自寄自取服務請聯繫客服告知。<br>
* 現時疫情對收派快件操作造成不同程度的影響，所有快件的時效將不作保證<br>
* 最新資訊以順豐速運公告為基準`;
